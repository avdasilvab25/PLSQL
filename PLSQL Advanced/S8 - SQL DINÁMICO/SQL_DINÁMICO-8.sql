...
BEGIN
    ...
    REGIONES(2) := 'ANTÁRTIDA';
    REGIONES(3) := 'NUEVA ZELANDA';

    ID_CURSOR := DBMS_SQL.OPEN_CURSOR;
    DBMS_SQL.PARSE(ID_CURSOR, 'INSERT INTO REGIONES VALUES (:COD, :REG)', DBMS_SQL.NATIVE);
    
    DBMS_SQL.BIND_ARRAY(ID_CURSOR, ':COD', CODIGOS); -- ASOCIO TANTAS FILAS COMO POSICIONES TENGA CODIGOS
    DBMS_SQL.BIND_ARRAY(ID_CURSOR, ':REG', REGIONES); -- ASOCIO TANTAS FILAS COMO POSICIONES TENGA CODIGOS
